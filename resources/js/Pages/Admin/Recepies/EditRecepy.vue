            ...
            <div class="row gy-4 mt-1">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <input type="text" class="form-control" :class="form.errors.unit ? 'is-invalid' : ''"
                        placeholder="Inserisci unità di misura" v-model="form.unit" />
                ...
                <div v-for="(ing, index) in form.ingredients" :key="index" class="row g-2 align-items-end mb-2">
                    ...
                    <div class="col-3 col-md-4">
                        ...
                        <input type="number" min="0" class="form-control"
                            ...
                            v-model="form.ingredients[index].grams_used" placeholder="Grammi" />
                        <div v-if="form.errors[`ingredients.${index}.grams_used`]" class="text-danger">
