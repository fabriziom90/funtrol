        ...
        <form @submit.prevent="handleSubmitForm">
            <div class="row gy-4 mt-1">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <input type="text" class="form-control" :class="form.errors.description ? 'is-invalid' : ''"
                        placeholder="Inserisci descrizione" v-model="form.description" />
                ...
                <div class="col-12 col-md-4">
                    ...
                    <input type="number" min="0" step="0.01" class="form-control"
                        :class="form.errors.price ? 'is-invalid' : ''" placeholder="Inserisci Prezzo"
                        v-model="form.price" />
            ...
            <div class="mt-3">
                ...
                <div v-for="(ing, index) in form.ingredients" :key="index" class="row g-2 align-items-end mb-2">
                    <div class="col-7 col-md-6">
                        ...
                        <div v-if="form.errors[`ingredients.${index}.product_id`]" class="text-danger">
                    ...
                    <div class="col-3 col-md-4">
                        ...
                        <input type="number" min="0" class="form-control" :class="hasIngredientError(index, 'grams')"
                            v-model="form.ingredients[index].grams" placeholder="Grammi" />
                    ...
                    <div class="col-2 col-md-2 text-end">
                        <button type="button" class="btn btn-sm btn-outline-danger" @click="removeIngredient(index)"
                            :disabled="form.ingredients.length === 1" title="Rimuovi">
                            &times;
                        </button>
                    </div>
                </div>
